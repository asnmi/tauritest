  ...
  return (
    <div className="toolbar">
      ...
      <button
        ...
        title={'search'}
        type="button"
        className={`toolbar-item spaced ${showSearch ? 'active' : ''}`}
        aria-label="Search">
        <i className="search" />
      </button>

      {showSearch && <SearchPlugin onClose={() => setShowSearch(false)} />}
          ...
          {canViewerSeeInsertDropdown && (
            <>
              ...
              <DropDown
                ...
                <DropDownItem
                  onClick={() => {
                    activeEditor.dispatchCommand(INSERT_INVOKER_COMMAND, undefined);
                  }}
                  className="item">
                  <i className="icon invoker" />
                  <span className="text">Invoker</span>
                </DropDownItem>

                <DropDownItem
                  onClick={() => {
                    activeEditor.dispatchCommand(INSERT_MATH_COMMAND, undefined);
                  }}
                  className="item">
